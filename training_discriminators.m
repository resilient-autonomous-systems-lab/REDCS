function [effect_net_trained,stealth_net_trained] = training_discriminators(effect_net,stealth_index,Z_attack_data,effect_index,stealth_index,loss_curve_param_dis1,loss_curve_param_dis2,i_epoch)
