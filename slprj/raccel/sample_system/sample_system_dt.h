...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . m2hykcpgz2
) , 0 , 0 , 359 } , { ( char_T * ) ( & rtB . mphsseyujn ) , 8 , 0 , 1 } , { (
char_T * ) ( & rtDW . jflrz4f2zz ) , 0 , 0 , 1 } , { ( char_T * ) ( & rtDW .
ecs1y5aje0 . LoggedData ) , 11 , 0 , 12 } , { ( char_T * ) ( & rtDW .
jircoqfdva ) , 7 , 0 , 1 } , { ( char_T * ) ( & rtDW . fvuql44emp ) , 8 , 0 ,
1 } } ; static DataTypeTransitionTable rtBTransTable = { 6U , rtBTransitions
} ; static DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
A [ 0 ] ) , 0 , 0 , 1738 } } ; static DataTypeTransitionTable rtPTransTable =
{ 1U , rtPTransitions } ;
